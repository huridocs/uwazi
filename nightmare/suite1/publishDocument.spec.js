...
selectors.doc = {
  form: {
    ...
    suporPowers: {
      regeneration:
        '#metadataForm > div:nth-child(3) > div:nth-child(4) > ul > li.wide > ul > li.multiselectItem > label',
    },
    nemesis: {
      daneryl:
        '#metadataForm > div:nth-child(3) > div:nth-child(2) > ul > li.wide > ul > li:nth-child(2) > label',
      joker:
        '#metadataForm > div:nth-child(3) > div:nth-child(2) > ul > li.wide > ul > li:nth-child(3) > label',
    },
  },
  viewer: {
    title:
    ...
    company:
      '#app > div.content > div > div > aside.side-panel.metadata-sidepanel.is-active > div.sidepanel-body > div > div.tab-content-visible > div > div.view > dl:nth-child(2) > dd',
    nemesis:
      '#app > div.content > div > div > aside.side-panel.metadata-sidepanel.is-active > div.sidepanel-body > div > div.tab-content-visible > div > div.view > dl:nth-child(3) > dd > ul > li:nth-child(1) > a',
    superpowers:
      '#app > div.content > div > div > aside.side-panel.metadata-sidepanel.is-active > div.sidepanel-body > div > div.tab-content-visible > div > div.view > dl:nth-child(4) > dd > ul',
  },
};

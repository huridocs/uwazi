...
export default {
  ...
  entityView: {
    ...
    firstAttachmentEditTitleButton:
      '#app > div.content > div > div > main > div > div.tab-content.tab-content-visible > div > div > div.attachments-list-parent > div.attachments-list > div > div > ul > li:nth-child(3) > a',
    attachmentFormInput: '#attachmentForm > div > div > input',
    attachmentFormSubmit:

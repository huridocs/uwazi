...
export default {
  settingsView: {
    ...
    firstDictionaryValForm: '#app > div.content > div > div > div.settings-content > div > form > div > div.thesauri-values > ul > div:nth-child(2) > div > div > input',
    secondDictionaryValForm: '#app > div.content > div > div > div.settings-content > div > form > div > div.thesauri-values > ul > div:nth-child(1) > div > div > input',
  ...
  libraryView: {
    ...
    deleteButtonConfirmation: 'body > div.ReactModalPortal > div > div > div > div.modal-footer > button.btn.confirm-button.btn-danger',
    loadMore: '#app > div.content > div > div > main > div.documents-list > div > div.row > div:nth-child(2) > a:nth-child(1)',
  ...
  documentView: {
    ...
    sidePanelFirstAttachmentTitle: '#app > div.content > div > div > aside.side-panel.metadata-sidepanel.is-active > div.sidepanel-body > div > div.tab-content.tab-content-visible > div > div:nth-child(2) > div:nth-child(1) > div > div > a > span > span',
    sidePanelFirstAttachmentEditTitleButton: '#app > div.content > div > div > aside.side-panel.metadata-sidepanel.is-active > div.sidepanel-body > div > div.tab-content.tab-content-visible > div > div:nth-child(2) > div:nth-child(1) > div > div > div > div > button:nth-child(1)',
    attachmentFormInput: '#attachmentForm > div > div > input',
    attachmentFormSubmit: '#app > div.content > div > div > aside.side-panel.metadata-sidepanel.is-active > div.sidepanel-body > div > div.tab-content.tab-content-visible > div > div:nth-child(2) > div:nth-child(1) > div > div > div.attachment-buttons > div > button.item-shortcut.btn.btn-success',
    attachmentFormCancel: '#app > div.content > div > div > aside.side-panel.metadata-sidepanel.is-active > div.sidepanel-body > div > div.tab-content.tab-content-visible > div > div:nth-child(2) > div:nth-child(1) > div > div > div.attachment-buttons > div > button.item-shortcut.btn.btn-primary',
  ...
  entityView: {
    ...
    firstAttachmentEditTitleButton: '#app > div.content > div > div > main > div > div.tab-content.tab-content-visible > div > div > div:nth-child(2) > div.attachments-list > div > div > div > button:nth-child(1)',
    attachmentFormInput: '#attachmentForm > div > div > input',
  ...
  uploadsView: {
    ...
    saveButton: '#app > div.content > div > div > aside.side-panel.metadata-sidepanel.is-active > div.sidepanel-footer > span > button.btn.btn-success',
    publishButton: '#app > div.content > div > div > aside.side-panel.metadata-sidepanel.is-active > div.sidepanel-footer > span > button.publish.btn.btn-success',
    multiPublishButton: '#app > div.content > div > div > aside.side-panel.multi-edit.is-active > div.sidepanel-footer > button.publish.btn.btn-success',

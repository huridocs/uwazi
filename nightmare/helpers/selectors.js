...
export default {
  settingsView: {
    ...
    createFilterGroupButton:        '#app > div.content > div > div > div.settings-content > div > div.FiltersForm-list.col-sm-9 > div > div.panel-heading > div > button.pull-right.btn.btn-sm.btn-default',
    newFilterGroupForm:             '#app > div.content > div > div > div.settings-content > div > div.FiltersForm-list.col-sm-9 > div > div:nth-child(2) > ul > div > div > div.input-group > input',
    ...
    translationInputEs:             '#app > div.content > div > div > div.settings-content > div > form > div > ul > li:nth-child(4) > div:nth-child(3) > div > div > input',
    translationsSaveButton:         '#app > div.content > div > div > div.settings-content > div > form > div > div > button'
  },
  libraryView: {

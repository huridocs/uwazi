...
export default {
  ...
  libraryView: {
    ...
    firstEntityViewButton:
      '#app > div.content > div > div > div > main > div > div > div.item-group > div:nth-child(1) > div.item-actions > div:nth-child(2) > a',
    documentTypeFilter:
      '#app > div.content > div > div > div > aside.library-filters > .sidepanel-body > .filters-box > #filtersForm  li.wide.documentTypes-selector > ul > li:nth-child(4) > label > span.multiselectItem-name',
    editEntityButton:
    ...
    superVillianType:
      '#app > div.content > div > div > div > aside.library-filters > .sidepanel-body > .filters-box > #filtersForm li.wide.documentTypes-selector > ul > li:nth-child(2) > label > span.multiselectItem-name',
    minorVillianType:
      '#app > div.content > div > div > div > aside.library-filters > .sidepanel-body > .filters-box > #filtersForm li.wide.documentTypes-selector > ul > li:nth-child(5) > label > span.multiselectItem-name',
    resetFilters:

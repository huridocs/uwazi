...
export default {
  settingsView: {
    ...
    firstDictionaryValForm: '#app > div.content > div > div > div.settings-content > div > form > div > div.thesauri-values > div:nth-child(2) > ul > div.list-group-item.draggable > div > div > input',

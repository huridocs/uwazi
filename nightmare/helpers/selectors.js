...
export default {
  ...
  documentView: {
    ...
    sidePanelFirstAttachmentEditTitleButton: '#app > div.content > div > div > aside.side-panel.metadata-sidepanel.is-active > div.sidepanel-body > div > div.tab-content.tab-content-visible > div > div:nth-child(2) > div.attachments-list > div > div > div > button',
    attachmentFormInput: '#attachmentForm > div > div > input',
    attachmentFormSubmit: '#app > div.content > div > div > aside.side-panel.metadata-sidepanel.is-active > div.sidepanel-body > div > div.tab-content.tab-content-visible > div > div:nth-child(2) > div.attachments-list > div > div.attachment-buttons > div > button.item-shortcut.btn.btn-success',
    attachmentFormCancel: '#app > div.content > div > div > aside.side-panel.metadata-sidepanel.is-active > div.sidepanel-body > div > div.tab-content.tab-content-visible > div > div:nth-child(2) > div.attachments-list > div > div.attachment-buttons > div > button.item-shortcut.btn.btn-primary',

...
import { Icon } from 'UI';
import { withContext, withRouter } from '../../componentWrappers.js';
import { AttachmentsList } from '../../Attachments.js';
import { ConnectionsGroups, ConnectionsList, ResetSearch } from '../../ConnectionsList.js';
import { CreateConnectionPanel, actions as connectionsActions } from '../../Connections.js';
import { MetadataFormButtons, ShowMetadata } from '../../Metadata.js';
import { RelationshipsFormButtons } from '../../Relationships.js';
import { TemplateLabel, Icon as PropertyIcon } from '../../Layout.js';
import { connectionsChanged, deleteConnection } from '../../ConnectionsList/actions/actions.js';

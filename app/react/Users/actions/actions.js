...
export function deleteUser(user) {
  return dispatch => UsersAPI.delete(new RequestParams(user))
  .then(() => {
...
export function saveUser(user) {
  return dispatch => UsersAPI.save(new RequestParams(user))
  .then(() => {
...
export function newUser(user) {
  return dispatch => UsersAPI.new(new RequestParams(user))
  .then(() => {
    dispatch(basicActions.push('users', user));

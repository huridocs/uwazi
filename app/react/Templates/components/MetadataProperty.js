  ...
  render() {
    ...
    if (this.props.isCommonProperty) {
      return (
        <li className="list-group-item">
          <span className="property-name"><Icon icon="lock fa-fw" />&nbsp;<i className={iconClass} />&nbsp;{label}</span>
    ...
    const result = connectDropTarget(
      <li className={propertyClass}>
        <span className="property-name"><Icon icon="reorder" fixedWidth />&nbsp;<i className={iconClass} />&nbsp;{label}</span>
        <div className="list-group-item-actions">

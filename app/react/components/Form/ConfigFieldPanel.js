...
class ConfigFieldPanel extends Component {
  ...
  save(e) {
    ...
    Object.keys(this.fields).forEach(fieldName => {
      if (!this.fields[fieldName].value) {
        throw new Error(fieldName + ' has no value function !');
      }
  ...
  render() {
    ...
    return (
        <div>
          <button type="button" className="btn btn-xs btn-default" aria-label="Config" onClick={this.toggleModal.bind(this)}>

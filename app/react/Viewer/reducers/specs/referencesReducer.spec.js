...
describe('Viewer referencesReducer', () => {
  ...
  describe('SET_REFERENCES', () => {
    it('should set document passed', () => {
      const newState = referencesReducer(null, { type: types.SET_REFERENCES, references: [{ title: 'test' }] });
  ...
  describe('ADD_CREATED_REFERENCE', () => {
    it('should should add reference passed', () => {
      const newState = referencesReducer(Immutable.fromJS([1]), { type: types.ADD_REFERENCE, reference: 2 });

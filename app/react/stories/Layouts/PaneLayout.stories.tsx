          ...
          <PaneLayout.Pane key="pane-1" header="Heading 1" footer="Footer 1">
            <div>
              <p>
                ...
                lorem porta porta. Mauris a tincidunt enim, eget venenatis est. Aenean euismod ex
                sem. Suspendisse aliquam ligula quis leo luctus viverra vel ut ipsum. Aliquam a
                ultrices arcu, vitae hendrerit arcu. Sed a urna ac nisi ultrices pretium. Vivamus
                ante lacus, elementum sit amet pellentesque vitae, efficitur vitae purus. Vivamus
          ...
          <PaneLayout.Pane key="pane-2" header="Heading 2" footer="Footer 2">
            <div>
              <p>
                ...
                id interdum tempus. Sed condimentum lectus lacus, a imperdiet augue feugiat ut. Nam
                ac feugiat purus. Nullam dictum ornare blandit. Integer sed pulvinar justo, quis
                luctus erat. Etiam id metus sed sem aliquet hendrerit ac quis turpis. Duis posuere
                nunc elementum sem finibus ultrices. Nam sed libero aliquet mauris vulputate laoreet
                ac id neque.
              </p>
            </div>
          </PaneLayout.Pane>
          <PaneLayout.Pane key="pane-3" header="Heading 3" footer="Footer 3">
            <div>
              <p>
                ...
                justo. Mauris ultrices massa ullamcorper est porta iaculis vel quis metus.
                Pellentesque nibh sapien, maximus vitae porttitor eu, efficitur quis arcu. Praesent
                tristique ac tortor at rhoncus. Quisque quis velit porta, malesuada velit ut,
                suscipit nibh. Aenean sollicitudin sapien laoreet lectus ultricies, eu porttitor
                eros condimentum. Integer eu aliquet mauris. Vivamus interdum laoreet felis in
                pulvinar. Duis at risus a mi luctus luctus. Vivamus malesuada tellus erat, gravida

...
const Empty: Story = {
    render: () => {
        const mockEntity: Entity = {
            ...
            title: 'Test Entity',
            language: 'eng',
            creationDate: { _id: 'creationDate', name: 'creationDate', label: 'Date added', type: 'date', values: [{ value: Date.now(), label: new Date().toISOString() }] },
            editDate: { _id: 'editDate', name: 'editDate', label: 'Date modified', type: 'date', values: [{ value: Date.now(), label: new Date().toISOString() }] },
            metadata: [],
        };
        return (

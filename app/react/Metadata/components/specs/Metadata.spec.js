...
describe('Metadata', () => {
  ...
  it('should render a Multimedia entry when the metadata is type multimedia', () => {
    testMetadata([{ label: 'Multimedia Label', value: 'http://some.url.com/image.jpg', type: 'multimedia', style: 'cover' }]);
  });

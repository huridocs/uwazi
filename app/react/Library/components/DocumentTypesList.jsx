...
class DocumentTypesList extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    return (
      !Immutable.is(this.props.selectedTemplates, nextProps.selectedTemplates) ||
      !Immutable.is(this.props.settings, nextProps.settings) ||
  ...
  render() {
    ...
    return (
      <ul className="multiselect Immutable.is-active">

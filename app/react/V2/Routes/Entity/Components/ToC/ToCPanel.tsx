        ...
        <div className="flex flex-col gap-2 h-full">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 py-2">
              <p className="text-sm font-bold text-(--color-theme-text-primary)">
            ...
            {tocState.toc && tocState.toc.length > 0 && !tocState.isEditMode && (
              <div className="flex gap-4">
                <button
                  ...
                  className="text-sm font-medium transition text-(--color-theme-text-primary) hover:text-(--color-theme-text-secondary) disabled:cursor-not-allowed disabled:text-(--color-theme-text-muted)"
                >
          ...
          {tocState.toc && tocState.toc.length > 0 ? (
            ...
            <BlankState
              icon={
                <ListBulletIcon className="h-7 w-7 rounded-full p-1 [background-color:color-mix(in_srgb,var(--color-theme-border-default)_70%,transparent)] text-(--color-theme-text-primary)" />
              }

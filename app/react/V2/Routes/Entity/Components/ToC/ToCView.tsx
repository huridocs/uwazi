...
const ToCView = ({ generatedToc, panel }: ToCViewProps) => {
  ...
  return (
    <div className="flex h-full flex-col gap-(--spacing-theme-3) px-1">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2 py-2">
          ...
          {generatedToc ? (
            ...
            >
              <span className="flex items-center gap-(--spacing-theme-1) rounded-full bg-(--color-theme-surface-warm) px-(--spacing-theme-2) py-(--spacing-theme-0-5) text-xs font-semibold tracking-wide text-ink">

...
const SuggestionsTitle = ({
  ...
  return (
    <div className="flex gap-4">
      <div className="flex flex-wrap gap-2 items-center text-ink grow">
        <span className="flex justify-center items-center w-7 h-7 font-sans text-sm text-center text-ink bg-vellum rounded-full">
          {propGraphics}
        </span>

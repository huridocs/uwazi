...
const SuggestedValue = ({ value, suggestion }: { value: string; suggestion: string }) => {
  ...
  return (
    ...
    //     className="w-full h-full text-xs font-normal focus-visible:border-none"
    //   >
    //     <div>
    ...
    <>
      <div
        ...
        {...attributes.popper}
        style={styles.popper}
        className="max-w-md px-[10px] py-3 rounded mb-3 overflow-y-auto text-xs font-normal text-gray-500 bg-white shadow-md max-h-56 w-fit"
      >
        This is a popup
        <div ref={setArrowElement} style={styles.arrow} />
      </div>

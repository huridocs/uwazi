import { updateSuggestions, updateSuggestionsByEntity } from '../helpers';
import { suggestion1, suggestion2, entity1, suggestion3, entity2 } from './fixtures';

describe('suggestions table update helpers', () => {

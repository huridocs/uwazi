  ...
  return (
    ...
    >
      <section className="p-4">
        <h2 className="mb-4 text-sm font-bold tracking-wider text-(--color-theme-text-primary)">
      ...
      <section className="border-t border-solid [border-top-width:1px] p-4 [border-color:color-mix(in_srgb,var(--color-theme-border-default)_45%,transparent)]">
        <NeedAuthorization roles={['admin', 'editor']}>
          <h2 className="mb-2 text-sm font-bold tracking-wider text-(--color-theme-text-primary)">

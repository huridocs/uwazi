...
const PageEditorConfigTab = ({
  ...
  const sharedIdField = register('sharedId');
  ...
  return (
    <Tabs.Tab id="Configuration" label={<Translate>Configuration</Translate>}>
      <form>
        <input
          className="hidden"
          name={sharedIdField.name}
          ref={sharedIdField.ref}
          onChange={sharedIdField.onChange}
          onBlur={sharedIdField.onBlur}
        />
...
export type { PageEditorConfigTabProps };

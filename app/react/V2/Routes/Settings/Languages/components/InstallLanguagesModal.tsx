  ...
  return (
    <Modal size="lg">
      ...
      <Modal.Body className="pt-0">
        <Translate className="block px-2 pt-4 text-justify text-(--color-theme-text-secondary)">
      ...
      <Modal.Footer>
        <div className="flex flex-col w-full">
          <p className="w-full pt-0 pb-3 text-sm font-normal text-(--color-theme-text-muted)">

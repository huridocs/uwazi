...
import { PXTemplate, PXTable } from '#V2/Routes/Settings/ParagraphExtraction/types.js';
import { getTemplateProperties } from '#V2/Routes/Settings/ParagraphExtraction/utils/getTemplateProperties.js';

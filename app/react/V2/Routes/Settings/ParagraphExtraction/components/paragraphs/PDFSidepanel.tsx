...
const PDFSidepanel = ({ showSidepanel, setShowSidepanel, entity }: PDFSidepanelSidepanelProps) => {
  ...
  return (
    ...
    >
      ...
      <Sidepanel.Footer>
        <div className="sticky bottom-0 flex justify-end gap-2 border border-b-0 border-l-0 border-r-0 border-t px-4 py-2 bg-(--color-theme-surface-raised) [border-color:color-mix(in_srgb,var(--color-theme-border-default)_45%,transparent)]">
          <Button
            type="button"
            variant="secondary"
            onClick={() => {

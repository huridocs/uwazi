  ...
  return (
    <div className={`relative shrink-0 border-b border-border ${className}`}>
      <input
        ...
        className="h-8 min-h-8 w-full min-w-0 flex-1 rounded-none border-0 bg-transparent pl-3 pr-8 text-sm font-normal text-ink placeholder:text-sm placeholder:font-normal placeholder:text-ink-muted focus:outline-none focus:ring-0 disabled:cursor-not-allowed"
      />

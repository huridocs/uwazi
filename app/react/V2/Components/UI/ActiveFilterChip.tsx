...
const ActiveFilterChip = ({ label, color, onRemove, removeAriaLabel }: ActiveFilterChipProps) => (
  <span className="inline-flex h-6 max-w-[160px] items-center gap-1 truncate rounded border border-border/60 bg-warm pl-1.5 pr-1 text-micro font-medium text-ink-secondary">

...
const parseLocalizedDate = (dateString: string | undefined, language: string = 'en') => {
  ...
  const localeMap: Record<string, string> = {
    ...
    'no': 'nb', 'nor': 'nb', 'norwegian': 'nb', 'norsk': 'nb',
    'nb': 'nb', 'nob': 'nb', 'bokmål': 'nb',
    ...
    'be': 'be', 'bel': 'be', 'belarusian': 'be', 'беларуская': 'be',
    'mk': 'mk', 'mkd': 'mk', 'macedonian': 'mk', 'македонски': 'mk',
    'sr': 'sr', 'srp': 'sr', 'serbian': 'sr', 'српски': 'sr',
    'bs': 'bs', 'bos': 'bs', 'bosnian': 'bs', 'bosanski': 'bs',
    'sq': 'sq', 'sqi': 'sq', 'albanian': 'sq', 'shqip': 'sq',
    'mt': 'mt', 'mlt': 'mt', 'maltese': 'mt', 'malti': 'mt',
    'is': 'is', 'isl': 'is', 'icelandic': 'is', 'íslenska': 'is',
    'ga': 'ga', 'gle': 'ga', 'irish': 'ga', 'gaeilge': 'ga',
    'cy': 'cy', 'cym': 'cy', 'welsh': 'cy', 'cymraeg': 'cy',
    'eu': 'eu', 'eus': 'eu', 'basque': 'eu', 'euskera': 'eu',

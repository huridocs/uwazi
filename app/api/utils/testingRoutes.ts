...
const setUpApp = (route: Function, ...customMiddleware: ((req: Request, _es: Response, next: NextFunction) =>void)[] ): Application => {
  ...
  customMiddleware.forEach(customMiddleware => app.use(customMiddleware));
  route(app);

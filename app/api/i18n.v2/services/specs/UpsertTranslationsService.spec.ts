...
// @ts-expect-error TS(2307): Cannot find module '../i18n.v2/errors/translationE... Remove this comment to see the full error message
import { LanguageDoesNotExist } from '../i18n.v2/errors/translationErrors.js';

...
import migration from '#api/migrations/migrations/154-repair_select_parent_denormalization/index.js';
import { Fixture } from '#api/migrations/migrations/154-repair_select_parent_denormalization/types.js';
import {
  oneLanguageFixtures,
  multiLanguageFixtures,
  correctFixtures,
  entities as entityFixtures,
} from '#api/migrations/migrations/154-repair_select_parent_denormalization/specs/fixtures.js';

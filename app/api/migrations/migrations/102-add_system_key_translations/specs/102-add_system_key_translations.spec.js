...
} from '#api/migrations/migrations/102-add_system_key_translations/specs/fixtures.js';

const locales = ['en', 'es', 'hu'];
const newKeyValues = [
  {
    key: 'This cannot be changed after saving',
    value: 'This cannot be changed after saving',
  },
];

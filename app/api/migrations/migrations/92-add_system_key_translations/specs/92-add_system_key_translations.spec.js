...
import migration from '#api/migrations/migrations/92-add_system_key_translations/index.js';
import { fixtures, templateId, defaultTemplateName, defaultTemplateTitle } from '#api/migrations/migrations/92-add_system_key_translations/specs/fixtures.js';

const locales = ['en', 'es', 'hu'];
const newKeyValues = [
  {
    key: 'Could not detect the area for the selected text',
    value: 'Could not detect the area for the selected text, please try selecting again.',
  },
  { key: 'Clear PDF selection', value: 'Clear PDF selection' },
];

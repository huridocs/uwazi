...
import migration from '#api/migrations/migrations/66-add_system_key_translations/index.js';
import { fixtures, templateId, defaultTemplateName, defaultTemplateTitle } from '#api/migrations/migrations/66-add_system_key_translations/specs/fixtures.js';
...
const newKeyValues = [
  ...
  {
    key: 'Add supported properties',
    value: 'Add supported properties',
  },
  {
    key: 'Only supported properties are shown',
    value: 'Only supported properties are shown',
  },
];
...
describe('migration add_system_key_translations', () => {
  ...
  it('should have a delta number', () => {
    expect(migration.delta).toBe(66);
  });

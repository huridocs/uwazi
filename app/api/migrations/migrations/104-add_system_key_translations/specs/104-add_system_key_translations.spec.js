...
import migration from '#api/migrations/migrations/104-add_system_key_translations/index.js';
import { fixtures, templateId, defaultTemplateName, defaultTemplateTitle } from '#api/migrations/migrations/104-add_system_key_translations/specs/fixtures.js';
...
const newKeyValues = [
  ...
  },
  {
    ...
    value: 'added to hub with the following errors:',
  },
  {

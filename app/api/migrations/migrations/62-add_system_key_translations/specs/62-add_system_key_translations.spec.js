...
import migration from '#api/migrations/migrations/62-add_system_key_translations/index.js';
import { fixtures, templateId, defaultTemplateName, defaultTemplateTitle } from '#api/migrations/migrations/62-add_system_key_translations/specs/fixtures.js';

const locales = ['en', 'es', 'hu'];
const newKeyValues = [
  {
    key: 'Invalid home page url',
    value: 'Invalid home page url',
  },
];

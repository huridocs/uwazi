...
import migration from '#api/migrations/migrations/114-add_system_key_translations/index.js';
import { fixtures, templateId, defaultTemplateName, defaultTemplateTitle } from '#api/migrations/migrations/114-add_system_key_translations/specs/fixtures.js';
...
const newKeyValues = [
  ...
  {
    key: 'Entities across all languages',
    value: 'Entities across all languages',
  },
  {
    key: 'Files',
    value: 'Files',
  ...
  {
    key: 'Total files from main documents, supporting files and custom uploads',
    value: 'Total files from main documents, supporting files and custom uploads',
  },
];

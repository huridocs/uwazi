...
import migration, { newKeys, deletedKeys } from '#api/migrations/migrations/155-update_translations/index.js';
import fixtures from '#api/migrations/migrations/155-update_translations/specs/fixtures.js';
...
describe('migration update translations of settings new Users/Groups UI', () => {
  ...
  it('should add new translations per language', async () => {
    ...
    expect(translations.length).toBe(20);
  });

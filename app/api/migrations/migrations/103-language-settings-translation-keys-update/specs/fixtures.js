...
const commonContext = {
  ...
  values: [
    ...
    { key: 'Default language description', value: 'default translation' },
    {
      key: 'Some adavanced search features may not be available for this language.',
      value: 'Some adavanced search features may not be available for this language.',
    },
  ],
};

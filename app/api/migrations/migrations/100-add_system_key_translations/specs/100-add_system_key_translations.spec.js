...
import migration from '#api/migrations/migrations/100-add_system_key_translations/index.js';
import { fixtures, templateId, defaultTemplateName, defaultTemplateTitle } from '#api/migrations/migrations/100-add_system_key_translations/specs/fixtures.js';

const locales = ['en', 'es', 'hu'];
const newKeyValues = [
  {
    key: 'Create new entities and upload documents',
    value: 'Create new entities and upload documents',
  },
  { key: 'Create table of contents', value: 'Create table of contents' },
  { key: 'View entities', value: 'View entities' },
];

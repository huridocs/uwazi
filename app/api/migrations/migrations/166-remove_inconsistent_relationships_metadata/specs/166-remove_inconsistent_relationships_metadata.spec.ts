...
import migration from '#api/migrations/migrations/166-remove_inconsistent_relationships_metadata/index.js';
import { fixtures, ids, noReindexFixtures } from '#api/migrations/migrations/166-remove_inconsistent_relationships_metadata/specs/fixtures.js';
import { EntitySchema } from '#api/migrations/migrations/166-remove_inconsistent_relationships_metadata/types.js';

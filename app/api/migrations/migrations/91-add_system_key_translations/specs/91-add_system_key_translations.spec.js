...
import migration from '#api/migrations/migrations/91-add_system_key_translations/index.js';
import { fixtures, templateId, defaultTemplateName, defaultTemplateTitle } from '#api/migrations/migrations/91-add_system_key_translations/specs/fixtures.js';
...
describe('migration add_system_key_translations', () => {
  ...
  it('should have a delta number', () => {
    expect(migration.delta).toBe(91);
  });

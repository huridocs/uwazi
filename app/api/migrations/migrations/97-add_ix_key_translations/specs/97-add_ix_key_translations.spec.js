...
import migration from '#api/migrations/migrations/97-add_ix_key_translations/index.js';
import { fixtures, templateId, defaultTemplateName, defaultTemplateTitle } from '#api/migrations/migrations/97-add_ix_key_translations/specs/fixtures.js';
...
const newKeyValues = [
  ...
  },
  {
    ...
    value: 'This will cancel the finding suggestion process',
  },
];
...
describe('migration add_system_key_translations', () => {
  ...
  it('should have a delta number', () => {
    expect(migration.delta).toBe(97);
  });

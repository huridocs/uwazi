...
import migration, { newKeys, deletedKeys } from '#api/migrations/migrations/164-update-translations/index.js';
import { fixtures } from '#api/migrations/migrations/164-update-translations/specs/fixtures.js';
import { Fixture } from '#api/migrations/migrations/164-update-translations/types.js';
...
describe('migration update translations of settings', () => {
  ...
  it('should have a delta number', () => {
    expect(migration.delta).toBe(164);
  });

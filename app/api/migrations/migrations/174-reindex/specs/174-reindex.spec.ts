...
import migration from '#api/migrations/migrations/174-reindex/index.js';
import { Fixture } from '#api/migrations/migrations/174-reindex/types.js';
import { fixtures } from '#api/migrations/migrations/174-reindex/specs/fixtures.js';
...
describe('migration test', () => {
  ...
  it('should have a delta number', () => {
    expect(migration.delta).toBe(174);
  });

...
import migration from '#api/migrations/migrations/105-add_system_key_translations/index.js';
import { fixtures, templateId, defaultTemplateName, defaultTemplateTitle } from '#api/migrations/migrations/105-add_system_key_translations/specs/fixtures.js';

const locales = ['en', 'es', 'hu'];
const newKeyValues = [
  {
    key: 'by ids, methods, keywords, etc.',
    value: 'by ids, methods, keywords, etc.',
  },

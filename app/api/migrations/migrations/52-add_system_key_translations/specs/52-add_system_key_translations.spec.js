...
import migration from '#api/migrations/migrations/52-add_system_key_translations/index.js';
import fixtures, { templateId, defaultTemplateName, defaultTemplateTitle } from '#api/migrations/migrations/52-add_system_key_translations/specs/fixtures.js';
...
const newKeyValues = [
  ...
  {
    key: 'Shared as viewer',
    value: 'Shared as viewer',
  },
  {
    key: 'Shared as editor',
    value: 'Shared as editor',
  },
];
...
describe('migration add_system_key_translations', () => {
  ...
  it('should have a delta number', () => {
    expect(migration.delta).toBe(52);
  });

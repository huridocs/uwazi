...
export default {
  entities: [
    ...
    { _id: db.id(), sharedId: 'shared3', type: 'entity', language: 'es', title: 'Inherit from me', creationDate: 1, published: true, metadata: { text: 'text es' }, file: { filename: '8202c463d6158af8065022d9b5014ccb.pdf' }, attachments: [{ filename: '8202c463d6158af8065022d9b5014ccc.pdf' }], fullText: { 1: 'text' } },
    { _id: db.id(), sharedId: 'shared3', type: 'entity', language: 'pt', title: 'Inherit from me', creationDate: 1, published: true, metadata: { text: 'text pt' }, file: { filename: '8202c463d6158af8065022d9b5014ccb.pdf' }, attachments: [{ filename: '8202c463d6158af8065022d9b5014ccc.pdf' }], fullText: { 1: 'text' } },

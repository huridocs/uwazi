...
} from '#api/core/domain/template/NumericProperty.js';
import {
  PreviewProperty,
  PreviewPropertyProps,
} from '#api/core/domain/template/PreviewProperty.js';
import {
  MultiDateProperty,
  MultiDatePropertyProps,
} from '#api/core/domain/template/MultiDateProperty.js';
import {
  MultiDateRangeProperty,
  MultiDateRangePropertyProps,
} from '#api/core/domain/template/MultiDateRangeProperty.js';
import { MediaProperty, MediaPropertyProps } from '#api/core/domain/template/MediaProperty.js';
import {
  MarkdownProperty,
  MarkdownPropertyProps,
} from '#api/core/domain/template/MarkdownProperty.js';
...
} from '#api/core/domain/template/GeoLocationProperty.js';
import {
  DateRangeProperty,
  DateRangePropertyProps,
} from '#api/core/domain/template/DateRangeProperty.js';
import { DateProperty, DatePropertyProps } from '#api/core/domain/template/DateProperty.js';
import {
  GenerateIdProperty,
  GenerateIdPropertyProps,
} from '#api/core/domain/template/GenerateIdProperty.js';
import {
  SelectProperty,
  SelectPropertyProps,

...
const createSut = (props?: CreateSutProps) => {
  ...
  const sut = new RequestBulkDeleteEntityUseCase(
    {
...
describe('RequestBulkDeleteEntityUseCase', () => {
  beforeAll(async () => {
  ...
  it('should delete entities', async () => {
    ...
    const input: RequestBulkDeleteEntityInput = {
      sharedIds: ['A1', 'A2', 'B1'],
    };

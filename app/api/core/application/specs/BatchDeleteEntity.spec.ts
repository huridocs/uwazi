...
import { BatchDeleteEntityUseCase, BatchDeleteEntityUseCaseInput } from '../BatchDeleteEntity';
...
const createSut = (props?: CreateSutProps) => {
  ...
  const sut = new BatchDeleteEntityUseCase({
...
describe('BatchDeleteEntityUseCase', () => {
  beforeAll(async () => {
  ...
  it('should delete entities', async () => {
    ...
    const input: BatchDeleteEntityUseCaseInput = {
      sharedIds: ['A1', 'B1'],
    };

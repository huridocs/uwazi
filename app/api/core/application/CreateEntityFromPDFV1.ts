...
class CreateEntityFromPDFV1UseCase extends AbstractUseCase<Input, Output, Deps> {
...
export { CreateEntityFromPDFV1UseCase };
export type { Input as CreateEntityFromPDFV1UseCaseInput };

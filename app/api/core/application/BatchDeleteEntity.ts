...
class BatchDeleteEntityUseCase extends AbstractUseCase<Input, Output, Deps> {
...
export { BatchDeleteEntityUseCase };
export type { Input as BatchDeleteEntityUseCaseInput, Output as BatchDeleteEntityUseCaseOutput };

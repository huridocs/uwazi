...
- **ElasticSearch 7.9.1** https://www.elastic.co/guide/en/elasticsearch/reference/7.6/install-elasticsearch.html Please note that ElasticSearch requires java. Follow the instructions to instal the package manually, you also probably need to disable ml module in the ElasticSearch config file:

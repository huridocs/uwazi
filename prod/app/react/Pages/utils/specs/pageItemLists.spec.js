...
var _pageItemLists = _interopRequireDefault(require("../pageItemLists"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /* eslint-disable max-len */
...
describe('Pages: pageItemLists util', () => {
  ...
  it('should extract the search URLs from the lists', () => {
    const { params } = _pageItemLists.default.generate(content);
  ...
  it('should extract optional additional parameters', () => {
    const { options } = _pageItemLists.default.generate(content);
  ...
  it('should return the content with list placeholders', () => {
    const newContent = _pageItemLists.default.generate(content).content;
  ...
  it('should return empty if no content', () => {
    const listsData = _pageItemLists.default.generate();

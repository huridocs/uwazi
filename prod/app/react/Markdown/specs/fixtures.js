"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  getAggregations: {
    dataset1: {
      aggregations: {
        all: {
          property1: { buckets: [{ key: 'id3', filtered: { doc_count: 5 } }, { key: 'id4', filtered: { doc_count: 7 } }] },
          property2: { buckets: [{ key: 'id5', filtered: { doc_count: 5 } }, { key: 'id6', filtered: { doc_count: 7 } }] } } } },
    ...
    dataset2: {
      aggregations: {
        all: {
          property3: { buckets: [{ key: 'id7', filtered: { doc_count: 6 } }, { key: 'id8', filtered: { doc_count: 76 } }] },
  ...
  getAggregation: {
    ...
    dataset2: {
      aggregations: {
        all: {
          _types: { buckets: [{ key: 'id5', filtered: { doc_count: 6 } }, { key: 'id7', filtered: { doc_count: 76 } }] },
          property4: { buckets: [{ key: 'id36', filtered: { doc_count: 36 } }] } } } } },
  ...
  getMetadataValue: {
    ...
    dataset2: {
      title: 'Entity 2',
      metadata: { progress: '1.5', otherProperty: '4' } } } };exports.default = _default;
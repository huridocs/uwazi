...
function mapDispatchToProps(dispatch, props) {
  return (0, _redux.bindActionCreators)({ changeTemplate: _Metadata.actions.changeTemplate, onSubmit: _libraryActions.saveDocument }, (0, _Multireducer.wrapDispatch)(dispatch, props.storeKey));
}var _default =

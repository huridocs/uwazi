"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.mapStateToProps = mapStateToProps;exports.default = exports.SearchButton = void 0;var _propTypes = _interopRequireDefault(require("prop-types"));
...
class SearchButton extends _react.Component {
  render() {
    ...
    return (
      _jsx("a", { href: "#", className: `search-button btn ${activeClass}`, onClick: toggle }, void 0,
      _jsx("div", { className: "searchButton-open" }, void 0,
      _jsx(_UI.Icon, { icon: "search" }),
      _jsx("span", {}, void 0, (0, _I18N.t)('System', 'Search'), "...")),

      _jsx("div", { className: "searchButton-close" }, void 0,
      _jsx(_UI.Icon, { icon: "chevron-right" }))));

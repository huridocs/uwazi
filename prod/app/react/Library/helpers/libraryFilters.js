"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.populateOptions = populateOptions;exports.parseWithAggregations = parseWithAggregations;exports.default = void 0;var _comonProperties = _interopRequireDefault(require("../../../shared/comonProperties"));
...
function URLQueryToState(query, templates, thesauris, relationTypes) {
  let properties = _comonProperties.default.comonFilters(templates, relationTypes, query.types);

  if (!query.types || !query.types.length) {
    properties = _comonProperties.default.defaultFilters(templates);
  }

...
var _prioritySortingCriteria = _interopRequireDefault(require("../prioritySortingCriteria"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

const prioritySortingCriteria = _prioritySortingCriteria.default.get;
  ...
  describe('Priority sorting', () => {
    ...
    it('should keep the selectedSorting if one exists and is valid for the selection', () => {
      const options = {
        ...
        selectedSorting: (0, _immutable.fromJS)({ sort: 'metadata.property0', order: 'desc', treatAs: 'string' }) };
    ...
    it('should default to prioritySorting instead of the selectedSorting if one exists and is invalid for the selection', () => {
      const options = {
        ...
        selectedSorting: (0, _immutable.fromJS)({ sort: 'metadata.nonExistentProperty', order: 'desc', treatAs: 'string' }) };

"use strict";var _RequestParams = require("../RequestParams");

describe('RequestParams', () => {
  it('should have data and headers accessible', () => {
    const requestParams = new _RequestParams.RequestParams('data', 'headers');
  ...
  describe('onlyHeaders', () => {
    it('should return a new RequestParams with only the headers', () => {
      const requestParams = new _RequestParams.RequestParams('data', 'headers').onlyHeaders();
  ...
  describe('add', () => {
    it('should return a new RequestParams with data merged', () => {
      const requestParams = new _RequestParams.RequestParams({ param: 'value' }, 'headers');

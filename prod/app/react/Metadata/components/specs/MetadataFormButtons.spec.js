...
var _MetadataFormButtons = require("../MetadataFormButtons");function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
describe('MetadataFormButtons', () => {
  ...
  beforeEach(() => {
    ...
    props = {
      ...
      data: (0, _immutable.fromJS)({ test: 'test', sharedId: 'shId', file: {} }),
      templates: (0, _immutable.fromJS)([{ test: 'test' }]),
      formName: 'FormName',
      formStatePath: 'form',
  ...
  const render = () => {
    component = (0, _enzyme.shallow)(_react.default.createElement(_MetadataFormButtons.MetadataFormButtons, props), { context });
  };
  ...
  describe('view', () => {
    ...
    it('should include a visible view button with the correct link', () => {
      const link = component.find(_I18N.I18NLink);
  ...
  describe('exclusivelyViewButton', () => {
    ...
    it('should only render a view button', () => {
      ...
      expect(component.find('.edit-metadata').at(0).find(_UI.Icon).props().icon).toBe('file');

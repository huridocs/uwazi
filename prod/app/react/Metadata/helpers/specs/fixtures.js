"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.thesauris = exports.templates = exports.relationships = exports.doc = void 0;var _immutable = _interopRequireDefault(require("immutable"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
const doc = {
  ...
  metadata: {
    ...
    select2: '' } };exports.doc = doc;



const relationships = _immutable.default.fromJS([
...
{ entity: 'linkedEntityWithoutMetadata', entityData: {} }]);exports.relationships = relationships;
...

{
  ...
  { name: 'nested', type: 'nested', label: 'Nested' }] }]);exports.templates = templates;




const thesauris = _immutable.default.fromJS([
{
  _id: 'thesauriId',
  name: 'Multiselect',
  type: 'template',
...

{
  ...
  { label: 'Entity 2 Title', id: 'linkedEntity2', _id: 'linkedEntity2', type: 'entity' }] }]);exports.thesauris = thesauris;
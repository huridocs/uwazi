...
describe('Connections actions', () => {
  ...
  beforeEach(() => {
    ...
    spyOn(_api.default, 'post').and.callFake(url => {
  ...
  describe('Search-related actions', () => {
    describe('immidiateSearch', () => {
      it('should search for connections', () => {
        ...
        const expectedParams = new _RequestParams.RequestParams({ searchTerm: 'term', fields: ['title'] });
        expect(_api.default.get).toHaveBeenCalledWith('search', expectedParams);
    ...
    describe('search', () => {
      it('should update the state searchTerm and debounce server searching the term', () => {
        ...
        expect(_api.default.get).toHaveBeenCalledWith('search', new _RequestParams.RequestParams({ searchTerm: 'term', fields: ['title'] }));
  ...
  describe('startNewConnection', () => {
    it('should perform an immediate empty search', () => {
      ...
      expect(_api.default.get).toHaveBeenCalledWith('search', new _RequestParams.RequestParams({ searchTerm: '', fields: ['title'] }));
    });
  ...
  describe('saveConnection', () => {
    ...
    it('should set the creating flag to true and attempt to save the connection (using the new hub format)', () => {
      const expectedParams = new _RequestParams.RequestParams({ delete: [],
        save: [[
      ...
      expect(_api.default.post).toHaveBeenCalledWith('relationships/bulk', expectedParams);
    });

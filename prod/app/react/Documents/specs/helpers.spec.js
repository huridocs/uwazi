"use strict";var _helpers = _interopRequireDefault(require("../helpers.js"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
describe('document helpers', () => {
  ...
  describe('prepareMetadata', () => {
    it('should prepare doc with document_type, metadata with label and thesauri values', () => {
      expect(_helpers.default.prepareMetadata(doc, templates, thesauris)).toEqual({
        title: 'doc title',
    ...
    describe('when a select has no value', () => {
      it('should not throw an error', () => {
        ...
        expect(_helpers.default.prepareMetadata.bind(null, doc, templates, thesauris)).not.toThrow();
      });
    });

    describe('when no templates provided', () => {
      it('should return the document with empty metadata', () => {
        expect(_helpers.default.prepareMetadata(doc, [], thesauris)).toEqual({
          title: 'doc title',
          template: '2',
          documentType: '',
          metadata: [] });

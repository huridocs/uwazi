...
var _LinkField = _interopRequireDefault(require("../LinkField"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
describe('LinkField', () => {
  ...
  const render = () => {
    component = (0, _enzyme.shallow)(_react.default.createElement(_LinkField.default, props));
  };

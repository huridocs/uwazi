...
class FormGroup extends _react.Component {
  render() {
    if (this.props.model) {
      ...
      return (
        _jsx(_reactReduxForm.Control.custom, {
          ...
          component: props => _jsx("div", { className: `${className} ${props.className}` }, void 0, props.children),
    ...
    return _jsx("div", { className: `form-group ${this.props.className}` }, void 0, this.props.children);

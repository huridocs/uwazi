...
describe('Customisation', () => {
  ...
  beforeEach(() => {
    ...
    component = (0, _enzyme.shallow)(
    _jsx(_Customisation.Customisation, {
      settings: _immutable.default.fromJS({ customCSS: 'custom', customSetting: 'anything' }),
      loadForm: loadForm,

...
var _AccountSettings = require("../AccountSettings");function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
describe('AccountSettings', () => {
  ...
  beforeEach(() => {
    ...
    spyOn(_UsersAPI.default, 'save').and.returnValue(Promise.resolve({ rev: 'rev' }));
    component = (0, _enzyme.shallow)(_react.default.createElement(_AccountSettings.AccountSettings, props));
  });
  ...
  describe('change email', () => {
    it('should save the user with the new email and update the user.rev', () => {
      ...
      expect(_UsersAPI.default.save).toHaveBeenCalledWith(new _RequestParams.RequestParams({ name: 'doe', email: 'newemail@uwazi.com' }));
    });
  });
  ...
  describe('change password', () => {
    it('should save the user with the new password', () => {
      ...
      expect(_UsersAPI.default.save).toHaveBeenCalledWith(new _RequestParams.RequestParams({ name: 'doe', password: 'ultraSecret' }));
    });
    ...
    describe('when passwords do not match', () => {
      it('should not update it', () => {
        ...
        component.find('form').at(1).simulate('submit', { preventDefault: () => {} });
        expect(_UsersAPI.default.save).not.toHaveBeenCalled();
      });

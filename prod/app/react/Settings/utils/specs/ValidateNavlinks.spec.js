"use strict";var _ValidateNavlinks = _interopRequireDefault(require("../ValidateNavlinks.js"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
describe('Navlinks Validator', () => {
  ...
  beforeEach(() => {
    ...
    validationRules = (0, _ValidateNavlinks.default)(links);
  });

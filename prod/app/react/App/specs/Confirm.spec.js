...
var _Confirm = _interopRequireDefault(require("../Confirm"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
describe('CantDeleteTemplateAlert', () => {
  ...
  const render = () => {
    component = (0, _enzyme.shallow)(_react.default.createElement(_Confirm.default, props));

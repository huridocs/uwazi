...
var _Document = require("../Document.js");function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
describe('Document', () => {
  ...
  beforeEach(() => {
    props = {
      ...
      doc: _immutable.default.fromJS({ _id: 'documentId', pdfInfo: { test: 'pdfInfo' } }),
      onDocumentReady: jasmine.createSpy('onDocumentReady'),
      selectedSnippet: _immutable.default.fromJS({}),
      docHTML: _immutable.default.fromJS({
  ...
  const render = () => {
    component = (0, _enzyme.shallow)(_react.default.createElement(_Document.Document, props));
  ...
  it('should add the correct LTR or RTL direction according to file franc language', () => {
    props.doc = props.doc.set('file', _immutable.default.fromJS({ language: 'eng' }));
    render();
    expect(component.find('.document').hasClass('force-ltr')).toBe(true);

    props.doc = props.doc.set('file', _immutable.default.fromJS({ language: 'arb' }));
    render();
  ...
  describe('onClick', () => {
    ...
    describe('when the target is a reference', () => {
      beforeEach(() => {
        props.references = _immutable.default.fromJS([{ reference: 'reference' }]);
      });

      it('should activate the reference', () => {
        props.executeOnClickHandler = true;
        props.references = _immutable.default.fromJS([{ _id: 'referenceId', test: 'test' }]);
  ...
  describe('when PDF is ready', () => {
    it('should call the onDocumentReady prop with the doc as argument', () => {
      render();
      const pdf = component.find(_PDF.default).first();
  ...
  describe('componentWillReceiveProps', () => {
    it('should unset selection if different doc', () => {
      ...
      instance.componentWillReceiveProps({ doc: _immutable.default.fromJS({ _id: 'documentId' }), selectedSnippet: _immutable.default.fromJS({}) });
      expect(props.unsetSelection.calls.count()).toBe(1);
      instance.componentWillReceiveProps({ doc: _immutable.default.fromJS({ _id: 'anotherId' }), selectedSnippet: _immutable.default.fromJS({}) });
  ...
  describe('onMouseUp/onTouchEnd', () => {
    beforeEach(() => {
      render();
      instance.text = (0, _Text.default)(instance.pagesContainer);
    });
  ...
  describe('onTextSelected', () => {
    beforeEach(() => {
      ...
      props.snippets = _immutable.default.fromJS(['snippet']);
      render();
      instance.text = (0, _Text.default)(instance.pagesContainer);

"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = _default;var _batarange = _interopRequireDefault(require("batarange"));
...
function _default(container) {
  return {
    ...
    getSelection() {
      ...
      const serializedRange = _batarange.default.serialize(range, container);
    ...
    wrapFakeSelection(range) {
      ...
      const restoredRange = _batarange.default.restore(offsetRange, container);
      const elementWrapper = document.createElement('span');
      elementWrapper.classList.add('fake-selection');
      this.fakeSelection = _wrapper.default.wrap(elementWrapper, restoredRange);
    },
    ...
    renderReferences(references, identifier = 'reference', elementWrapperType = 'a') {
      ...
      groupedReferencesbyRange.forEach(reference => {
        ...
        const restoredRange = _batarange.default.restore(ref, container);
        ...
        const renderedReference = _wrapper.default.wrap(elementWrapper, restoredRange);
        reference.ids.forEach(id => {
          this.renderedReferences[identifier][id] = renderedReference;
        });

        _utils.events.emit('referenceRendered', reference);
      });

...
describe('uploadsReducer', () => {
  ...
  describe('NEW_UPLOAD_DOCUMENT', () => {
    it('should set the progress for the document to 0', () => {
      ...
      const newState = (0, _progressReducer.default)(currentState, { type: types.NEW_UPLOAD_DOCUMENT, doc: 'doc2' });
  ...
  describe('UPLOAD_PROGRESS', () => {
    it('should set the progress for a document', () => {
      const currentState = _immutable.default.fromJS({ doc1: 45 });
      const newState = (0, _progressReducer.default)(currentState, { type: types.UPLOAD_PROGRESS, doc: 'doc2', progress: 36 });
  ...
  describe('UPLOAD_COMPLETE', () => {
    it('should unset upload progress for the document', () => {
      ...
      const newState = (0, _progressReducer.default)(currentState, { type: types.UPLOAD_COMPLETE, doc: 'doc1' });

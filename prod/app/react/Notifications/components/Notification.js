...
class Notification extends _react.Component {
  ...
  render() {
    ...
    return (
      _jsx("div", { className: cssClass, onClick: this.close.bind(this) }, void 0,
      _jsx(_UI.Icon, { icon: icon }),
      _jsx("span", {}, void 0, message),

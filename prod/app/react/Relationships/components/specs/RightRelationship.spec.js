...
var _RightRelationship = require("../RightRelationship");
...
describe('RelationshipsGraphEdit', () => {
  ...
  beforeEach(() => {
    ...
    props = {
      index: 0,
      hubActions: (0, _immutable.fromJS)({ editing: false }),
  ...
  const render = () => {
    component = (0, _enzyme.shallow)(_react.default.createElement(_RightRelationship.RightRelationship, props));
  };
  ...
  describe('render()', () => {
    ...
    it('should render the relationship groups', () => {
      ...
      expect(component.find(_Doc.default).length).toBe(4);
      expect(component.find(_Doc.default).at(0).props().doc).toEqual((0, _immutable.fromJS)(hub.rightRelationships[0].relationships[0].entityData));
      expect(component.find(_HubRelationshipMetadata.default).length).toBe(4);
      expect(component.find(_HubRelationshipMetadata.default).at(0).props().relationship).toEqual((0, _immutable.fromJS)(hub.rightRelationships[0].relationships[0]));
    });
  });
  ...
  describe('while editing', () => {
    beforeEach(() => {
      props.hubActions = (0, _immutable.fromJS)({ editing: true });
      render();
    });

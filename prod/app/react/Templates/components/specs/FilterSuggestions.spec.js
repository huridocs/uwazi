...
var _FilterSuggestions = require("../FilterSuggestions");function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
describe('FilterSuggestions', () => {
  ...
  function renderComponent(label = 'test', type = 'text', content) {
    ...
    component = (0, _enzyme.shallow)(_react.default.createElement(_FilterSuggestions.FilterSuggestions, props));
  }

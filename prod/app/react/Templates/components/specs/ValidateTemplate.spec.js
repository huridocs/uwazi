"use strict";var _ValidateTemplate = _interopRequireWildcard(require("../ValidateTemplate"));function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) {var desc = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : {};if (desc.get || desc.set) {Object.defineProperty(newObj, key, desc);} else {newObj[key] = obj[key];}}}}newObj.default = obj;return newObj;}}
...
describe('ValidateTemplate', () => {
  ...
  describe('validateDuplicatedLabel', () => {
    ...
    it('should return false if prop has same label', () => {
      ...
      expect((0, _ValidateTemplate.validateDuplicatedLabel)(prop, template)).toBe(false);
    ...
    it('should return true if same prop', () => {
      ...
      expect((0, _ValidateTemplate.validateDuplicatedLabel)(prop, template)).toBe(true);
    });
  ...
  describe('validate duplicated relationship', () => {
    ...
    it('should not allow 2 relationships that are equaly configured', () => {
      ...
      template.push(prop);
      expect((0, _ValidateTemplate.validateDuplicatedRelationship)(prop, template)).toBe(false);
    });
    ...
    it('should allow 2 relationships with diferent relationType configured', () => {
      ...
      template.push(prop);
      expect((0, _ValidateTemplate.validateDuplicatedRelationship)(prop, template)).toBe(true);
    });
  ...
  describe('validate required inherit property', () => {
    it('should not pass validation when a property is check as inherit but has no inherit property selected', () => {
      ...
      expect((0, _ValidateTemplate.validateRequiredInheritproperty)(prop, template)).toBe(false);
    });
  });
  ...
  describe('validator', () => {
    ...
    const makeValidator = () => {
      validator = (0, _ValidateTemplate.default)(properties, commonProperties, templates, id);
      return validator;
    };

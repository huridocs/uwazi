"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.TRANSITION_PROPS = exports.getMarkers = exports.markersToStyleFormat = exports.getMarkersBoudingBox = void 0;const getMarkersBoudingBox = markers => markers.reduce((_b, marker) => {
  const b = _b.slice();
  ...
  return b;
}, [[null, null], [null, null]]);exports.getMarkersBoudingBox = getMarkersBoudingBox;
...
});exports.markersToStyleFormat = markersToStyleFormat;
...
const TRANSITION_PROPS = {
  ...
  onStateChange: noop };exports.TRANSITION_PROPS = TRANSITION_PROPS;
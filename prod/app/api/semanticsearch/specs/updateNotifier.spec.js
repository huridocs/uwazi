"use strict";var _updateNotifier = require("../updateNotifier");
...
describe('updateNotifier', () => {
  let notifier;
  beforeEach(() => {
    notifier = new _updateNotifier.UpdateNotifier();
  });
  ...
  describe('notifySearchUpdate', () => {
    let updates;
    beforeEach(() => {
      jest.spyOn(_semanticSearch.default, 'getDocumentResultsByIds').mockResolvedValue(['doc1Res', 'doc2Res']);

"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  { method: 'PUT', url: '/api/templates', query: '{}', body: '{}', time: 1000, username: 'Hello' },
  { method: 'DELETE', url: '/api/entities', query: '{"sharedId":"123"}', body: '{}', time: 2000, username: 'admin' },
  { method: 'POST', url: '/api/semantic-search/notify-updates', query: '{}', body: '{}', time: 3000, username: 'admin' }] };exports.default = _default;
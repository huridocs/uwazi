"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.groupRelationships = exports.filterRelevantRelationships = void 0;function getGroupData(reference, groupedReferences, templates, relationTypes) {
...
ref => Boolean(ref.entity !== id && (ref.entityData && ref.entityData.published || user)));exports.filterRelevantRelationships = filterRelevantRelationships;

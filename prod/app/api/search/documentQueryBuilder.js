...
var _metadataAggregations = _interopRequireDefault(require("./metadataAggregations"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) {var desc = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : {};if (desc.get || desc.set) {Object.defineProperty(newObj, key, desc);} else {newObj[key] = obj[key];}}}}newObj.default = obj;return newObj;}} /* eslint-disable camelcase */
...
function _default() {
  ...
  return {
    ...
    filterMetadata(filters = []) {
      filters.forEach(filter => {
        const match = (0, _metadataMatchers.default)(filter);
        if (match) {
          addFilter(match);
        }
      });
    ...
    aggregations(properties, dictionaries) {
      properties.forEach(property => {
        baseQuery.aggregations.all.aggregations[property.name] = (0, _metadataAggregations.default)(property, dictionaries, baseQuery);
      });
      return this;
    },

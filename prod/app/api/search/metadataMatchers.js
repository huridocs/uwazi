"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.relationshipfilter = exports.nestedFilter = exports.strictNestedFilter = exports.nestedrangeFilter = exports.multiselectFilter = exports.rangeFilter = exports.textFilter = exports.default = void 0;const textFilter = (filter, path = 'metadata') => ({ term: { [`${path}.${filter.name}.raw`]: filter.value } });exports.textFilter = textFilter;
...
const nestedrangeFilter = (filter, path = 'metadata') => {
  ...
  return match;
};exports.nestedrangeFilter = nestedrangeFilter;
